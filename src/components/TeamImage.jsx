...
export default function TeamImage({ teamData, ownerData = [], handleDownload }) {
    useEffect(() => {
        setTimeout(() => {
    ...
    return (
        <div id="myHiddenDiv" className="p-3 w-full flex items-center justify-between flex-wrap wrap absolute -z-10">
            {ownerData.length > 0 && (
                <div className="flex flex-col items-center justify-center">
                    ...
                    />
                    <p className="font-semibold capitalize my-2">{ownerData[0].owner}(Owner)</p>
                </div>
            )}
