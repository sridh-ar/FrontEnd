...
// import { CardBody, CardContainer, section } from "./ui/3d-card";
...
export default function PlayersCard({
  ...
  return (
    <div>
      <div>
        <div
          className={`bg-white shadow p-3 mx-2 flex h-full items-center  rounded-md ${fromRegisterMenu ? "w-[100%]" : "w-[90%]"
            }`}
        >
          <section
            translateZ="50"
        ...
        {!fromRegisterMenu &&
          (approved ? (
            <section className="absolute top-2 right-10" translateZ="40">
