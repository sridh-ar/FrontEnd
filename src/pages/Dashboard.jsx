        ...
        <SidebarContainer isLoading={isLoading}>
            ...
            <div className="flex">
                <div className="flex items-center text-[0.6rem] gap-2 bg-[#d4dced] custom-shape px-10 py-2">
                    <h1 className="font-bold text-2xl">{analyticalData.totalRegisteredPlayers}</h1>
                    <section>
                ...
                <div className="flex items-center text-[0.6rem] gap-2 px-10">
                    <h1 className="font-bold text-2xl">{analyticalData.totalTeams}</h1>
                    <section>
                        <p className="relative top-0.5">Total</p>
                        <p>Teams</p>
                    </section>
                ...
                <div className="flex items-center text-[0.6rem] gap-2 px-10">
                    <h1 className="font-bold text-2xl">{analyticalData.totalTeamPlayers}</h1>
                    <section>
